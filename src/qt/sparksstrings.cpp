...
"transaction that are not equal 1000 SPARKS."),
QT_TRANSLATE_NOOP("sparks-core", ""
...
QT_TRANSLATE_NOOP("sparks-core", "Copyright (C) 2014-%i The Sparks Core Developers"),
...
QT_TRANSLATE_NOOP("sparks-core", "Keep N SPARKS anonymized (default: %u)"),
